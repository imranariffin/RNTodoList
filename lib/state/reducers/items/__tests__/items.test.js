...
describe('items reducer', () => {
  ...
  describe('action is `DISMISS_ALL_ERRORS`', () => {
    const state = {
      byIds: {
        someActiveItem: {
          id: 'someActiveItem',
  ...
  describe('action is `ITEMS_STORAGE_LOAD_PENDING`', () => {
    const state = {
      byIds: {},
      allIds: [],
      activeIds: [],
  ...
  describe('action is `ITEMS_STORAGE_LOAD_SUCCESS`', () => {
    const state = {
      byIds: {},
      allIds: [],
      activeIds: [],
  ...
  describe('action is `ITEMS_STORAGE_LOAD_FAILURE`', () => {
    const state = {
      byIds: {
        someActiveItem: {
          id: 'someActiveItem',
